...
if __name__ == "__main__":
    ...
    run_demo(save_dir="outputs/azure", llm_model_name="gpt-4o-mini", embedding_model_name="text-embedding-3-small", azure_endpoint=args.azure_endpoint, azure_embedding_endpoint=args.azure_embedding_endpoint)
